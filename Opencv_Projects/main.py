...
if __name__ == '__main__':
    ...
    detection_runners.REMOVE_DOWNSCALING_IN_VIDEOS = True
    ...
    detection_runners.ANALYSE_EVERY_X_FRAME = 3     # 3 only looks normal because now the inference time = typical frame time. the inference isnt beeing addet to the frame time because analysing the frame is quicker then the frame time
